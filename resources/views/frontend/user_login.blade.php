                                    ...
                                    @if(get_setting('google_login') == 1 || get_setting('facebook_login') == 1 || get_setting('twitter_login') == 1 || get_setting('apple_login') == 1)
                                        ...
                                        <ul class="list-inline social colored text-center mb-5">
                                            ...
                                            @if(get_setting('google_login') == 1)
                                                ...
                                                <div class="list-inline-item col-md-6 col-sm-12">
                                                    <a class="m-1 d-flex align-items-center px-1 bg-soft-dark border-0 text-dark" style="border-radius: 40px; width: 100%;" href="{{ route('social.login', ['provider' => 'google']) }}">
                                                        <!-- <button > -->
                                                            <img style="width: 40px;" src="https://cdn1.iconfinder.com/data/icons/google-s-logo/150/Google_Icons-09-512.png" alt="...">
                                                            <p style="margin: revert;letter-spacing: 1px" class="px-2 fw-500">Google</p>
                                                        <!-- </button> -->
                                                    </a>
                                                </div>
                                            @endif
