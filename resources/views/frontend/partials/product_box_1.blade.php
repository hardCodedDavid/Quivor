<div class="aiz-card-box border border-light rounded hov-shadow-md mt-1 mb-2 has-transition bg-white">
    ...
    <div class="p-md-3 p-2 text-left">
        ...
        <button type="button" class="btn btn-soft-primary w-100 mt-2 add-to-cart fw-600" onclick="showAddToCartModal({{ $product->id }})">
            <i class="las la-shopping-bag"></i>
            <span class=""> Add to cart</span>
        </button>
        @else
        <a href="{{ $product_url }}">
            <button type="button" class="btn btn-soft-primary w-100 mt-2 add-to-cart fw-600">
