                ...
                <div class="row">
                    ...
                    <div class="col-xl-7 col-lg-6">
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                <div class="col-6 text-right">
                                    @php
                                        ...
                                        //}
                                    @endphp
                                    <span class="badge badge-md badge-inline badge-pill badge-success text-capitalize">{{ translate('Available')}}</span>
                                </div>
                            </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-auto">
                                    <small class="mr-2 opacity-50">{{ translate('Posted by')}}: </small><br>
                            ...
                            <div class="mt-3">
                                <button type="button" class="btn btn-sm btn-success mr-2 buy-now fw-600" style="padding: 10px 30px;" onclick="show_contact_modal()">
                                    <i class="las la-comments fs-2tx"></i> {{ translate('Contact Agent') }}
                                </button>
...
@section('modal')
    ...
    <div class="modal fade" id="contact_modal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                <div class="modal-header">
                    <h5 class="modal-title fw-600 h5">Contact Agent</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
