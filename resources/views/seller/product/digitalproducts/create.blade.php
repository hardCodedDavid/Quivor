...
@section('panel_content')
    ...
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">{{ translate('Add Your Properties') }}</h1>
            </div>
        </div>
    </div>
    <form class="" action="{{route('seller.digitalproducts.store')}}" method="POST" enctype="multipart/form-data" id="choice_form">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    <label class="col-lg-3 col-from-label">{{translate('Properties Name')}} <span class="text-danger">*</span></label>
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="name" placeholder="{{translate('Properties Name')}}" required>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Properties Information')}}</h5>
            </div>
            <div class="card-body">
                <div class="form-group row">
        ...
        <div class="card">
            <div class="card-header">
                <h5 class="mb-0 h6">{{translate('Meta Tags')}}</h5> <span class="bg-soft-primary text-primary fw-600 text-sm px-3 py-1 rounded">optional</span>
            </div>
            <div class="card-body">
                <div class="form-group row">
        ...
        <div class="form-group mb-0 text-right mb-2">
            <button type="submit" class="btn btn-primary">{{translate('Save Properties')}}</button>
        </div>
    </form>
