...
@section('panel_content')
    <div class="aiz-titlebar mt-2 mb-4">
        <div class="row align-items-center">
            <div class="col-md-6">
                <h1 class="h3">{{ translate('Update Your Properties') }}</h1>
            </div>
        </div>
    </div>
    <form class="" action="{{route('seller.digitalproducts.update', $product->id)}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="form-group row">
                    ...
                    <div class="col-lg-9">
                        <input type="text" class="form-control" name="name" placeholder="{{translate('Properties Name')}}" value="{{$product->getTranslation('name', $lang)}}" required>
                    </div>
                </div>
        ...
        <div class="card">
            <div class="card-header">
                ...
                <span class="bg-soft-primary text-primary fw-600 text-sm px-3 py-1 rounded">optional</span>
            </div>
            <div class="card-body">
                <div class="form-group row">
