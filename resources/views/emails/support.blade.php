...
<a target="_blank" rel="noopener noreferrer" href="{{ $link }}" class="button button-primary" style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; -webkit-text-size-adjust: none; border-radius: 4px; color: #fff; display: inline-block; overflow: hidden; text-decoration: none; background-color: #A4018F; border-bottom: 8px solid #A4018F; border-left: 18px solid #A4018F; border-right: 18px solid #A4018F; border-top: 8px solid #A4018F;">{{ translate('See ticket') }}</a>
